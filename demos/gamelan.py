...
if __name__ == '__main__':
    ...
    track0 = Seq.metaseq(ins={i: Vibraphone for i in range(microdivs)}, microdivs=microdivs)
    ...
    s11=spray(score, pitch=72, duration=2, rhythm=1/3, amplitude=A(.18),
                 ...
                 end=36, microdivs=microdivs)
    s12=spray(score, pitch=60, duration=2, rhythm=.5, amplitude=A(.25), band=scale2, end=41, microdivs=microdivs)
    s13=spray(score, pitch=48, duration=4, rhythm=[1, 1, 2, 1, 1, 1, 1, 1, .5, .5, 2, 1, .5, .5, 1, 1, 2, 2, .5, .5, 1, 4],
                 amplitude=A(.35), band=scale3, end=32, microdivs=microdivs)
    s14=brush(score, pitch=[[36, 42.6, 43.1, 48, 51.8, 57.3, 63.8, 86.4], [12, 24, 31.1, 36, 42.6]],
                 length=2, duration=8, rhythm=[4, 8], amplitude=A(.25), microdivs=microdivs)
